...
export const dummyUsers: User[] = [
  {
    ...
    password_hash: "$2b$12$abcdefghijklmnopqrstuv.wx/yz/ABCDEFGHIJKLMNO",
  ...
  },
  {
    ...
    role: 2, // Assuming 2 is an admin role
    email: "bob@example.com",
    password_hash: "$2b$12$bcdefghijklmnopqrstuv.wx/yz/BCDEFGHIJKLMNOPQ",
